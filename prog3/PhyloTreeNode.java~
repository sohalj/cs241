...
public class PhyloTreeNode {
    ...
    private double distanceToChild;        // Edge weight to left and right children (0 for terminals)
    ...
    public String toString() {
        if( this.isLeaf() ) {
            ...
            return "[NONTERM " +  new java.text.DecimalFormat("0.00").format(this.getDistanceToChild()) + "]";
        }
    }
